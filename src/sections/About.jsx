...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText(' riosgenuziosergio@gmail.com');
        setHasCopied(true);
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">riosgenuziosergio@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
